  ...
  <q-page class="q-pa-sm">
    <div class="row q-col-gutter-sm">
      <div class="col-12 text-center">
        <span class="text-h6 text-bold">GESTIÓN DE INCIDENCIAS</span>
      </div>
      ...
      <div class="col-12 q-gutter-sm text-right">
        ...
        <q-btn label="NUEVO INCIDENCIA" @click="eventoBtnNuevaIncidencia" icon="add" color="green" size="sm"></q-btn>
      </div>
      <div class="col-12">
        <q-table
          :data="incidentes"
          :columns="columnasTablaIncidente"
          ...
          <template v-slot:top-right>
            <q-input borderless v-model="textoFiltro" placeholder="Buscar" outlined dense>
                  ...
                  <q-list>
                    <q-item v-close-popup>
                      <q-item-section avatar>
                        <q-avatar icon="search" color="grey" text-color="white" />
                      </q-item-section>
                      <q-item-section>
                        Consultar incidente
                      </q-item-section>
    ...
    <q-dialog v-model="dialogoIncidenciaVisible" @hide="eventoOcultarDialogoPersona" full-width persistent>
      <q-card style="width: 600px;">
        <q-card-section class="bg-header-dialog">
          ...
          <div class="text-body2 text-bold">Agregar incidente</div>
        </q-card-section>
        <q-card-section>
          <FormRegistroIncidentes @cerrar-dialogo="eventoOcultarDialogoIncidente" @cargar-incidentes="cargarIncidentes" />
        </q-card-section>
      </q-card>
    </q-dialog>
...
import FormRegistroIncidentes from "components/FormRegistroIncidentes.vue";

export default {
  name: 'GestionIncidencias',
  components: {FormRegistroIncidentes},
  data() {
    return {
      ...
      columnasTablaIncidente: [
        {name: 'a', label: 'CÓDIGO', field: 'codigo', align: 'center'},
        {name: 'b', label: 'FECHA', field: 'fecha', align: 'center'},
        {name: 'c', label: 'LUGAR', field: 'lugarNombre', align: 'left'},
        {name: 'd', label: 'SERVICIOS CRÍTICOS AFECTADOS', field: 'serviciosAfectados', align: 'left'},
        {name: 'e', label: 'ALCANCE DE LA INTERRUPCIÓN', field: 'alcanceInterrupcion', align: 'left'},
        {name: 'f', label: 'RESPONSABLE', field: 'responsableNombre', align: 'left'},
      ...
      dialogoIncidenciaVisible: false,
  ...
  methods: {
    eventoBtnNuevaIncidencia: function () {
      this.dialogoIncidenciaVisible = true;
    },
    ...
    cargarIncidentes: function () {
      ...
      datos.append('action', 'INCIDENTES');
      ...
      this.$axios
        ...
        .catch((e) => {
          this.mostrarMensaje('ERROR AL CARGAR INCIDENTES', 'red', 'warning');
        })
        .finally(() => {
    ...
    eventoOcultarDialogoIncidente: function () {
      this.dialogoIncidenciaVisible = false;
    },
