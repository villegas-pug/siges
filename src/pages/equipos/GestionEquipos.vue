  ...
  <q-page class="q-pa-sm">
    <div class="row q-col-gutter-sm">
      <div class="col-12 text-center">
        <span class="text-h6 text-bold">GESTIÓN DE EQUIPOS</span>
      </div>
      <div class="col-12 row q-col-gutter-xs">
        ...
        <div class="col-12 col-sm-4">
          <q-select label="Entrega" v-model="filtros['entrega']" :options="entregas" emit-value map-options option-value="id" option-label="descripcion" dense outlined></q-select>
        </div>
        ...
        <q-card-section>
          <div class="row q-col-gutter-xs">
            ...
            <div class="col-12 col-sm-6">
              <q-input :label="'IMEI'+' (*)'" v-model="equipo.imei" mask="###############" dense outlined :filled="equipo.id!=null" :readonly="equipo.id!=null" class="borde-normal"></q-input>
            </div>
            <div class="col-12 col-sm-6">
              <q-input :label="'Modelo / marca'+' (*)'" v-model="equipo.modeloDesc" dense outlined :filled="equipo.id!=null" :readonly="equipo.id!=null" class="borde-normal"></q-input>
            ...
            <div class="col-12">
              <q-checkbox v-model="equipo.accesorio1" label="Accesorio 1" true-value="1" false-value="0" />
              <q-checkbox v-model="equipo.accesorio2" label="Accesorio 2" true-value="1" false-value="0" />
              <q-checkbox v-model="equipo.accesorio3" label="Accesorio 3" true-value="1" false-value="0" />
            </div>
            ...
            <div class="col-12">
              <q-input :label="'Dependencia'" v-model="equipo.dependenciaNombre" dense outlined :filled="equipo.id!=null" :readonly="equipo.id!=null" class="borde-normal"></q-input>
            </div>
            <div class="col-12">
              <q-field :label="'Dependencia'" dense outlined filled readonly class="borde-normal" stack-label>
                <template v-slot:control>
                </template>
                <template v-slot:append>
                  <q-icon name="search" class="text-blue cursor-pointer"></q-icon>

                  <q-icon v-if="equipo.depencia!=null" name="cancel" class="text-blue cursor-pointer"></q-icon>
                </template>
              </q-field>
            </div>
            <div class="col-12">
              <q-input :label="'Servicio'" v-model="equipo.cargoDesc" dense outlined :filled="equipo.id!=null" :readonly="equipo.id!=null" class="borde-normal"></q-input>
            </div>
            <div class="col-12">
              <q-input :label="'Asignado a'" v-model="equipo.personalNombre" dense outlined :filled="equipo.id!=null" :readonly="equipo.id!=null" class="borde-normal"></q-input>
            </div>
            <div class="col-12 col-sm-6">
              <q-input :label="'Fecha de asignación'" v-model="equipo.ultimaAsignacion" dense outlined :filled="equipo.id!=null" :readonly="equipo.id!=null" class="borde-normal"></q-input>
            </div>
            <div class="col-12 col-sm-6">
              <q-input :label="'Estado'" v-model="equipo.estadoDesc" dense outlined :filled="equipo.id!=null" :readonly="equipo.id!=null" class="borde-normal"></q-input>
            </div>
                  ...
                  <q-td :props="scope">
                    <q-btn-dropdown size="sm" dropdown-icon="settings" class="q-mr-xs acciones" no-icon-animation>
                      <q-list>
                        ...
                        <q-separator v-if="[4435].includes(scope.row.motivoFin)" inset />

                        <q-item v-if="[4435].includes(scope.row.motivoFin)" @click="eventoOpcVerDocumentosDevolucion(scope.row)" clickable v-close-popup>
                          <q-item-section avatar>
                            <q-avatar :icon="'description'" color="red" text-color="white" />
                          </q-item-section>
                          <q-item-section>
                            <span>Ver documentos de devolución</span>
                          </q-item-section>
                        </q-item>
                      </q-list>
                    </q-btn-dropdown>
        ...
        <q-card-section>
          <div class="row q-col-gutter-xs">
            ...
            <div class="col-12 col-sm-6">
              ...
              <!--<q-select label="Motivo (*)" v-model="movimiento.motivoFin" :options="motivosFin" @input="eventoSeleccionMotivo" emit-value map-options option-value="id" option-label="descripcion" :option-disable="m=>[4428,4435].includes(m.id)" dense outlined class="borde-normal"></q-select>-->
            </div>
            <div class="col-12 col-sm-6">
            ...
            <div v-if="movimiento.motivoFin===4435" class="col-12">
              <q-field label="Nuevo archivo" dense outlined readonly stack-label class="borde-normal">
                <template v-slot:control>
                  <span v-if="archivoAdjuntoDevolucion!=null">{{archivoAdjuntoDevolucion.name}}</span>
                </template>
                <template v-slot:append>
                  <q-icon name="add" v-if="archivoAdjuntoDevolucion!=null" @click="eventoOpcAgregarArchivoDevolucion" class="text-blue cursor-pointer">
                    <q-tooltip>AGREGAR ARCHIVO A LA LISTA</q-tooltip>
                  </q-icon>
                  <q-icon name="cancel" v-if="archivoAdjuntoDevolucion!=null" @click="archivoAdjuntoDevolucion=null" class="text-blue cursor-pointer">
                    <q-tooltip>REMOVER ARCHIVO</q-tooltip>
                  </q-icon>
                  <q-icon name="attach_file" @click="eventoOpcAdjuntarArchivoDevolucion" class="text-blue cursor-pointer">
                    <q-tooltip>ADJUNTAR ARCHIVO</q-tooltip>
                  </q-icon>
                </template>
              </q-field>
              <q-file style="display: none;" ref="refArchivoAdjuntoDevolucion" v-model="archivoAdjuntoDevolucion" accept="application/pdf" @rejected="eventoErrorAdjuntarArchivo"></q-file>
            </div>
            <div v-if="movimiento.motivoFin===4435" class="col-12">
              <q-table :data="archivosDevolucion" :columns="columnasTablaArchivoDevolucion" table-header-class="bg-inabif" dense></q-table>
            </div>
            <div class="col-12">
              <q-input label="Observaciones" type="textarea" v-model="movimiento.observaciones" dense outlined maxlength="150" class="borde-normal" input-style="resize: none; height: 60px;"></q-input>
            </div>
    ...
    <q-dialog v-model="dialogoDocumentosDevolucionVisible" @hide="documentosDevolucion=[]" persistent>
      <q-card style="width: 600px;">
        <q-card-section class="bg-header-dialog">
          <span style="float: right;">
            <q-btn icon="close" v-close-popup flat round size="sm"></q-btn>
          ...
          <div class="text-body2 text-bold">Documentos de devolución</div>
        </q-card-section>
        <q-card-section>
          <div class="row q-col-gutter-sm">
            <!--<div class="col-10">
            ...
            <div class="col-12">
              <q-table
                :data="documentosDevolucion"
                :columns="columnasTablaDocumentosDevolucion"
                table-header-class="bg-inabif"
                :loading="cargandoDocumentosDevolucion"
                :rows-per-page-options="opcionesFilasPorPagina"
                dense>
                <template v-slot:body-cell-opciones="scope">
                  <q-td :props="scope">
                    <q-btn icon="search" @click="eventoBtnVerArchivo(scope.row)" size="sm"></q-btn>
                  </q-td>
                </template>
              </q-table>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      contratos: [],
      entregas: [
        {id: 1, descripcion: 'PRIMERA ENTREGA'}, {id: 2, descripcion: 'SEGUNDA ENTREGA'},
      ],
      modelos: [],
      ...
      archivoAdjuntoDevolucion: null,
      archivosDevolucion: [],
      columnasTablaArchivoDevolucion: [
        {name: 'archivo', label: 'ARCHIVO', field: 'name', align: 'left'},
      ...
      columnasTablaDocumentosDevolucion: [
        {name: 'nombre', label: 'NOMBRE', field: 'nombre', align: 'left'},
        {name: 'opciones', label: 'OPCIONES', align: 'center'},
      ],
      archivosAtencion: [],
      ...
      dialogoDocumentosDevolucionVisible: false,
      ...
      cargandoDocumentosDevolucion: false,
  ...
  methods:  {
      ...
      this.$axios
        ...
        .then(response => {
          ...
          if (this.contratos.length>0) {
            this.filtros['contrato'] = this.contratos[1].id;
            this.cargarModelos();
          }
        })
        .catch((e) => {
    ...
    eventoOpcVerDocumento: function (asignacion) {
    },
    ...
    eventoOpcVerDocumentosDevolucion: function (asignacion) {
      let datos = new FormData();
      datos.append('action', 'DOCUMENTOS_DEVOLUCION');
      datos.append('valores', ''.concat(asignacion.id, '|'));

      this.cargandoDocumentosDevolucion = true;
      this.$axios
        .post(`${this.host}/SConsulta`, datos, this.requestMultipartConfig)
        .then(response => {
          this.documentosDevolucion = response.data;
        })
        .catch((e) => {
          this.mostrarMensaje('ERROR AL CARGAR DOCUMENTOS', 'red', 'warning');
        })
        .finally(() => {
          this.cargandoDocumentosDevolucion = false;
        });

      this.dialogoDocumentosDevolucionVisible = true;
    },
    ...
    guardarMovimiento: function () {
      ...
      for (let f=0 ; f<this.archivosDevolucion.length ; f++) {
        if (this.archivosDevolucion[f].id == null) {
          datos.append('archivo', this.archivosDevolucion[f]);
        }
      }

      this.cargandoGuardadoMovimiento = true;
      this.$axios
        .post(`${this.host}/SDevolucion`, datos, this.requestMultipartConfig)
    ...
    eventoOpcAgregarArchivoDevolucion: function () {
      this.archivosDevolucion.push(this.archivoAdjuntoDevolucion);

      this.archivoAdjuntoDevolucion = null;
    },
    eventoOpcAdjuntarArchivo: function () {
      this.$refs.refArchivoAdjunto.pickFiles();
    },
    eventoOpcAdjuntarArchivoDevolucion: function () {
      this.$refs.refArchivoAdjuntoDevolucion.pickFiles();
    },
